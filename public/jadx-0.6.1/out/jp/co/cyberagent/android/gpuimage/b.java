...
public class b implements PreviewCallback, Renderer {
        ...
        if (this.n.isEmpty()) {
            a(new Runnable(this) {
                ...
                public void run() {
                    ...
                    this.d.d = c.a(this.d.h, previewSize, this.d.d);
    ...
    public void a(final a aVar) {
        a(new Runnable(this) {
            ...
            public void run() {
                ...
                this.b.c.a();
                GLES20.glUseProgram(this.b.c.h());
        ...
        if (bitmap != null) {
            a(new Runnable(this) {
                ...
                public void run() {
                    ...
                    this.c.d = c.a(createBitmap != null ? createBitmap : bitmap, this.c.d, z);
