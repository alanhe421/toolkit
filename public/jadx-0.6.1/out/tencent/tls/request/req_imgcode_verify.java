...
public class req_imgcode_verify extends oicq_request {
    public req_imgcode_verify(req_global tencent_tls_request_req_global) {
        this._cmd = a.b;
        this._sub_cmd = 2;
    ...
    public byte[] get_request_body(final byte[] bArr) {
        ...
        TLVPacker anonymousClass1 = new TLVPacker(new int[]{260, 8, 2}) {
            protected byte[] loop(int i) {
                byte[] bArr = new byte[0];
                switch (i) {
                    case 2:
                        return new tlv_t2().get_tlv_2(bArr, tencent_tls_request_async_context._t105.get_sign());
                    case 8:
    ...
    public int make_request(String str) {
        ...
        int i2 = 0;
        while (true) {
            get_request(this._default_client_version, this._cmd, this._default_client_seq, this._g._uin, this._default_ext_retry, this._default_ext_type, i, this._default_ext_instance, get_request_body(str.getBytes()));
