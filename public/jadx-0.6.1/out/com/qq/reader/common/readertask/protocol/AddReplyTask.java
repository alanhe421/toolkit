...
public class AddReplyTask extends ReaderProtocolJSONTask {
    public AddReplyTask(String str, int i, String str2, String str3, String str4, String str5, long j, int i2, int i3) {
        if (i == 1) {
            this.mUrl = e.bB + "bid=" + str + "&replytype=" + i + "&commentid=" + str2 + "&replyid=" + str3 + "&replyuid=" + str4 + "&signal=" + j + "&ctype=" + i3;
            this.mRequest = wrapJsonData(str5);
        } else {
            this.mUrl = e.bB + "bid=" + str + "&replytype=" + i + "&commentid=" + str2 + "&signal=" + j + "&chapterid=" + i2 + "&ctype=" + i3;
            this.mRequest = wrapJsonData(str5);
        }
        setFailedType(1);
    }
