...
public class RefreshView extends ViewGroup {
    ...
    private class c extends AsyncTask<Void, Integer, Void> {
        ...
        private c(RefreshView refreshView) {
            this.a = refreshView;
        }
    ...
    private void a() {
        ...
        this.m = new Handler(this) {
            ...
            public void handleMessage(Message message) {
                com.qq.reader.common.monitor.debug.c.a("RefreshView", "handleMessage " + message.what);
                if (message.what == 101) {
                    this.a.f();
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        if (this.j != null) {
            this.j.layout(i, -this.j.getMeasuredHeight(), i3, 0);
        }
        if (this.k != null) {
    ...
    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        switch (action) {
            case 0:
                ...
                return false;
            case 2:
                if (this.p.b() && Math.abs(y - this.b) > Math.abs(x - this.a) && y - this.b > 0) {
                    return true;
                }
                if (this.l != 0 && y - this.b < 0) {
                    return true;
                }
                break;
        }
    ...
    private void b() {
        this.i = (int) (((float) (this.j.getMeasuredHeight() * 3)) / 1.3f);
    }
