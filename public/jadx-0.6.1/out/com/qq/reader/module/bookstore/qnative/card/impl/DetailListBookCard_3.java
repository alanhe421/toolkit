...
public class DetailListBookCard_3 extends a {
    ...
    static /* synthetic */ int access$312(DetailListBookCard_3 detailListBookCard_3, int i) {
        int i2 = detailListBookCard_3.changeStartPos + i;
        detailListBookCard_3.changeStartPos = i2;
        return i2;
    }
    ...
    private View getSingleItemView(final g gVar) {
        ...
        inflate.setOnClickListener(new OnClickListener(this) {
            final /* synthetic */ DetailListBookCard_3 b;
    ...
    private View getMultiItemView(List<s> list) {
        ...
        if (charSequence == null) {
            ...
            textView.setOnClickListener(new OnClickListener(this) {
                final /* synthetic */ DetailListBookCard_3 a;
                ...
                public void onClick(View view) {
                    if (this.a.mMoreAction != null) {
                        ...
                        if ("columbooks".equals(string)) {
                            ...
                            DetailListBookCard_3.access$312(this.a, 4);
                            ...
                            this.a.mMoreAction.a().a().putString("KEY_ACTIONID", ((g) this.a.getItemList().get(0)).q());
