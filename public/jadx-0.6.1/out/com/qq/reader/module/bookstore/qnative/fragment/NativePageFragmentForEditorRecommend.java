...
public class NativePageFragmentForEditorRecommend extends NativePageFragmentforOther {
    ...
    class a extends XListViewFooter {
        final /* synthetic */ NativePageFragmentForEditorRecommend a;

        public a(NativePageFragmentForEditorRecommend nativePageFragmentForEditorRecommend, Context context) {
            this.a = nativePageFragmentForEditorRecommend;
            super(context);
        }

        protected void a(Context context) {
            this.c = context;
            this.h = (RelativeLayout) LayoutInflater.from(this.c).inflate(R.layout.editorrecommend_xlistview_footer, null);
            addView(this.h);
    ...
    public void initCardListView(View view, boolean z) {
        if (this.mXListView == null) {
            ...
            this.mXListView.setXListFooter(new a(this, ReaderApplication.getApplicationContext()));
