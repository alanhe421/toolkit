...
public class MonthlyChargeAdvTextCard extends ChargeBaseCard {
    private final String TAG = "ChargeAdvTextCard";
    private String mAdContent;

    public MonthlyChargeAdvTextCard(b bVar, String str) {
        super(bVar, str);
    }
    ...
    protected boolean parseData(JSONObject jSONObject) throws Exception {
        this.mAdContent = jSONObject.optString("title");
