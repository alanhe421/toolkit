...
public class BookclubSpecilaCommentListCard extends BaseCommentCard {
    ...
    class a {
        ...
        boolean q = false;
        int r;
        final /* synthetic */ BookclubSpecilaCommentListCard s;

        a(BookclubSpecilaCommentListCard bookclubSpecilaCommentListCard) {
            this.s = bookclubSpecilaCommentListCard;
        }
    ...
    class b extends s {
        ...
        int b;
        a c;
        final /* synthetic */ BookclubSpecilaCommentListCard d;

        b(BookclubSpecilaCommentListCard bookclubSpecilaCommentListCard) {
            this.d = bookclubSpecilaCommentListCard;
        }
    ...
    public BookclubSpecilaCommentListCard(com.qq.reader.module.bookstore.qnative.page.b bVar, String str, int i) {
        super(bVar, str, i);
        setCardId(str);
    }
        ...
        if (inflate != null) {
            ...
            inflate.setOnClickListener(new OnClickListener(this) {
                ...
                public void onClick(View view) {
                    ...
                    i.a("event_C176", null, ReaderApplication.getApplicationImp());
                }
            });
        }
        return inflate;
