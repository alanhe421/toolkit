...
/* compiled from: PersonalityListAdapter */
public class i extends BaseAdapter {
    ...
    public i(Context context, ListCardCommon listCardCommon, boolean z) {
        this.a = context;
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (vVar != null && vVar.a()) {
            view = ((LayoutInflater) view.getContext().getSystemService("layout_inflater")).inflate(this.e.getCardItemLayoutId(), null);
        }
