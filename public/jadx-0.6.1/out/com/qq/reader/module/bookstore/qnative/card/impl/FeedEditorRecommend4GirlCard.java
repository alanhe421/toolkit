...
public class FeedEditorRecommend4GirlCard extends FeedMultiClickBaseCard implements b {
    ...
    public FeedEditorRecommend4GirlCard(com.qq.reader.module.bookstore.qnative.page.b bVar, String str, boolean z) {
        super(bVar, str);
    ...
    protected void doClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.concept_more_button:
                if (!this.isUsedAsFeedCard) {
                    ...
                    try {
                        ...
                        i.a("event_F16", null, ReaderApplication.getApplicationImp().getApplicationContext());
                        return;
                    } catch (Exception e) {
                        return;
                    }
            ...
            case R.id.section_1:
                ...
                if (this.isUsedAsFeedCard) {
                    i.a("event_F13", null, ReaderApplication.getApplicationImp().getApplicationContext());
                    return;
                }
                return;
            case R.id.section_2:
            ...
            case R.id.single_book_info:
                ...
                if (this.isUsedAsFeedCard) {
                    i.a("event_F11", null, ReaderApplication.getApplicationImp().getApplicationContext());
                    return;
                }
                return;
            default:
    ...
    public int getResLayoutId() {
        return R.layout.feed_editor_recommend_girl;
    }
    ...
    public void attachView() {
        ...
        showStatics();
        if (this.isUsedAsFeedCard) {
            i.a("event_F8", null, ReaderApplication.getApplicationImp().getApplicationContext());
            statExposure();
        }
    }
    ...
    private String getFeedStatString() {
        ...
        StringBuilder stringBuilder = new StringBuilder();
        int i = 0;
        while (i < 5 && i <= this.mBookItems.size() - 1) {
            g gVar;
            if (i == 0) {
    ...
    protected boolean parseData(JSONObject jSONObject) throws Exception {
        ...
        if (!this.isUsedAsFeedCard) {
            ...
            return true;
        } else if (jSONObject.optInt("style") != 8) {
            return false;
        } else {
        ...
        while (views != null && i < views.size()) {
            try {
                ((View) views.get(i)).setOnClickListener(new com.qq.reader.module.bookstore.qnative.c.c(this) {
                    final /* synthetic */ FeedEditorRecommend4GirlCard a;
