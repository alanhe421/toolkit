...
public class AudioZoneBookDiscountCard extends a {
    ...
    public AudioZoneBookDiscountCard(b bVar, String str) {
        super(bVar, str);
    }
    ...
    public void attachView() {
        ...
        if (this.moreType > 0) {
            ...
            cardMoreView.setOnClickListener(new OnClickListener(this) {
                final /* synthetic */ AudioZoneBookDiscountCard a;
        ...
        if (arrayList.size() > 0) {
            ...
            TextView textView3 = (TextView) ap.a(getRootView(), R.id.book0_price);
            TextView textView4 = (TextView) ap.a(getRootView(), R.id.book0_discount);
            ((AudioZoneBookHorItemView) ap.a(getRootView(), R.id.book0_cover)).setBookInfo(aVar, true);
            ...
            ap.a(getRootView(), R.id.book0_view).setOnClickListener(new OnClickListener(this) {
                final /* synthetic */ AudioZoneBookDiscountCard b;
