...
public class ComicStoreFourItemCard extends ComicStoreBaseCard {
    private static final String TAG = "ComicStoreFourItemCard";
    private static final int[] comicItemResIds = new int[]{R.id.comic_four_card_00item, R.id.comic_four_card_01item, R.id.comic_four_card_10item, R.id.comic_four_card_11item};
    private b comicColumnInfo;

    public ComicStoreFourItemCard(com.qq.reader.module.bookstore.qnative.page.b bVar, String str) {
        super(bVar, str);
    }
    ...
    public void attachView() {
        if (this.comicColumnInfo != null) {
            ...
            if (TextUtils.isEmpty(i2) || this.comicColumnInfo.h() <= 4) {
                i = 8;
            } else {
                i = 0;
            }
            ...
            a.setOnClickListener(new OnClickListener(this) {
                final /* synthetic */ ComicStoreFourItemCard b;
            ...
            while (i3 < comicItemResIds.length && i3 < this.comicColumnInfo.g()) {
                ComicSingleBookBigView comicSingleBookBigView = (ComicSingleBookBigView) ap.a(rootView, comicItemResIds[i3]);
                final q qVar = (q) this.comicColumnInfo.f().get(i3);
                comicSingleBookBigView.setAllData(qVar);
                comicSingleBookBigView.a(qVar.i(), qVar.a(ao.a(156.0f), ao.a(150.0f)));
                final String valueOf = String.valueOf(qVar.a());
                comicSingleBookBigView.setOnClickListener(new OnClickListener(this) {
                    final /* synthetic */ ComicStoreFourItemCard c;
