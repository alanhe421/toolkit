...
public class FeedSingleBookCard extends FeedBaseCard {
    ...
    public FeedSingleBookCard(b bVar, String str) {
        super(bVar, str);
    }
    ...
    public boolean parseData(JSONObject jSONObject) {
        ...
        if (optJSONObject != null) {
            optJSONObject.optString(JSON_KEY_STAT_TAGS);
            optJSONObject.optString(JSON_KEY_STAT_ALGINFO);
        }
        ...
        optJSONObject = jSONObject.optJSONObject(JSON_KEY_DLFILE);
