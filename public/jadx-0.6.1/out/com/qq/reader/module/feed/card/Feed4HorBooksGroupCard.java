...
public class Feed4HorBooksGroupCard extends FeedMultiClickBaseCard {
    ...
    private class a {
        ...
        String h;
        String i;
        final /* synthetic */ Feed4HorBooksGroupCard j;

        private a(Feed4HorBooksGroupCard feed4HorBooksGroupCard) {
            this.j = feed4HorBooksGroupCard;
            this.g = "";
            this.h = "";
            this.i = "";
        }
    ...
    public Feed4HorBooksGroupCard(com.qq.reader.module.bookstore.qnative.page.b bVar, String str) {
        super(bVar, str);
        this.JSON_BID = "bid";
        ...
        if (view != null) {
            ...
            try {
                ...
                view.postDelayed(new Runnable(this) {
                    final /* synthetic */ Feed4HorBooksGroupCard b;
