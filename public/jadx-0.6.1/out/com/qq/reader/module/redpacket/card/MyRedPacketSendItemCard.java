...
public class MyRedPacketSendItemCard extends com.qq.reader.module.bookstore.qnative.card.a {
    ...
    private class a extends s {
        ...
        public int e;
        public String f;
        final /* synthetic */ MyRedPacketSendItemCard g;

        private a(MyRedPacketSendItemCard myRedPacketSendItemCard) {
            this.g = myRedPacketSendItemCard;
        }
    ...
    public void attachView() {
        ...
        if (this.item != null) {
            ...
            getRootView().setOnClickListener(new OnClickListener(this) {
                final /* synthetic */ MyRedPacketSendItemCard a;
                ...
                public void onClick(View view) {
                    if (this.a.item != null && !TextUtils.isEmpty(this.a.item.f)) {
                        try {
                            c.a(this.a.getEvnetListener().getFromActivity(), (com.qq.reader.module.redpacket.b.a.c + this.a.item.f) + "&timi=" + d.z(ReaderApplication.getApplicationImp()) + "&skey=" + com.qq.reader.common.login.c.c().a(ReaderApplication.getApplicationImp()), null);
                        } catch (Exception e) {
                        }
                    }
                }
