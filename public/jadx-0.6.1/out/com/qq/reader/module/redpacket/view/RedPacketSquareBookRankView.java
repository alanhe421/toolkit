...
public class RedPacketSquareBookRankView extends RelativeLayout {
    private ImageView a;
    private ImageView b;
    private ImageView c;
    ...
    private void a(Context context) {
        LayoutInflater.from(context).inflate(R.layout.redpacket_square_book_rank_layout, this, true);
    }
    ...
    private void a() {
        ...
        this.d = (RelativeLayout) findViewById(R.id.redpacket_square_book_billboard_rl);
        this.d.setOnClickListener(new OnClickListener(this) {
            final /* synthetic */ RedPacketSquareBookRankView a;
            ...
            public void onClick(View view) {
                try {
                    c.a(this.a.e.getFromActivity(), d.bP(ReaderApplication.getApplicationImp().getApplicationContext()), null, null);
    ...
    private void a(ImageView imageView, String str) {
        com.qq.reader.common.imageloader.c.a(getContext()).a(str, imageView, com.qq.reader.common.imageloader.a.a().l());
    }
}
