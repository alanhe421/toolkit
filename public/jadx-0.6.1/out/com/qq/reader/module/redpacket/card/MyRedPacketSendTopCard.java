...
public class MyRedPacketSendTopCard extends a {
    private int amount;
    private int red_packet_count;

    public MyRedPacketSendTopCard(b bVar, String str) {
        super(bVar, str);
    }
    ...
    public void attachView() {
        ...
        textView.setText(String.format(ReaderApplication.getApplicationImp().getResources().getString(R.string.my_red_packet_count_sent_desc), new Object[]{String.valueOf(this.red_packet_count)}));
    }
}
