...
public class d {
    ...
    public void a(byte b, int i) {
        if (i < 15) {
            ...
            this.b.put((byte) (b | ETConverter.ET_CONVERTER_GLYPH_CACHE_SIZE_MASK));
            this.b.put((byte) i);
        } else {
    ...
    public void a(byte[] bArr, int i) {
        a(bArr.length + 8);
        a((byte) JceStruct.SIMPLE_LIST, i);
        a((byte) 0, 0);
        a(bArr.length, 0);
        this.b.put(bArr);
    }
