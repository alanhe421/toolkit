...
public class b {
    ...
    private String c() throws WeiboException {
        ...
        String a = this.h == null ? k.a(this.b, str) : this.h;
        String c = c(this.b);
        f fVar = new f(this.c);
        ...
        fVar.a("key_hash", a);
        try {
            str = HttpManager.a(this.b, "https://api.weibo.com/oauth2/getaid.json", Constants.HTTP_GET, fVar);
    ...
    private static String d(Context context) {
        ...
        try {
            ...
            d = h(context);
            if (!TextUtils.isEmpty(d)) {
                jSONObject.put(Constants.VIA_SHARE_TYPE_INFO, d);
            }
            d = e();
            if (!TextUtils.isEmpty(d)) {
                jSONObject.put("7", d);
    ...
    private static String a(String str, String str2) throws Exception {
        ...
        try {
            ...
            while (true) {
                try {
                    int a = a(bytes, i, (int) Opcodes.INVOKE_SUPER_RANGE);
                    if (a == -1) {
                        break;
                    }
