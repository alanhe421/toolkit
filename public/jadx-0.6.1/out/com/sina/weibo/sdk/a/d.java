...
class d {
    ...
    private static void b(Context context, c cVar) {
        com.sina.weibo.sdk.b.h.a.a().c(cVar.e()).a(c(context, cVar)).b(cVar.f()).a(cVar.e()).a(context).a(2);
    }

    /* JADX WARNING: inconsistent code. */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static android.app.PendingIntent c(android.content.Context r5, com.sina.weibo.sdk.a.c r6) {
        /*
        r0 = 0;
        r1 = r6.b();
        r2 = r6.c();
    ...
    L_0x003a:
        ...
        goto L_0x0025;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.sina.weibo.sdk.a.d.c(android.content.Context, com.sina.weibo.sdk.a.c):android.app.PendingIntent");
    }
    ...
    private static Intent a(String str) {
        ...
        if (!scheme.equalsIgnoreCase(c.d) && !scheme.equalsIgnoreCase("https")) {
            return null;
        }
        Intent intent = new Intent();
        intent.setAction("android.intent.action.VIEW");
