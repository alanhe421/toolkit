...
public class BSDiff {
    ...
    private static void split(int[] iArr, int[] iArr2, int i, int i2, int i3) {
        ...
        int i10;
        i8 = iArr2[iArr[(i2 / 2) + i] + i3];
        i6 = 0;
        i7 = 0;
        for (i10 = i; i10 < i + i2; i10++) {
            if (iArr2[iArr[i10] + i3] < i8) {
                i7++;
            }
            if (iArr2[iArr[i10] + i3] == i8) {
                i6++;
        ...
        while (i5 + i6 < i9) {
            if (iArr2[iArr[i5 + i6] + i3] == i8) {
                i6++;
            } else {
                i10 = iArr[i5 + i6];
                iArr[i5 + i6] = iArr[i9 + i7];
                iArr[i9 + i7] = i10;
                i7++;
            }
        }
    ...
    private static int search(int[] iArr, byte[] bArr, int i, byte[] bArr2, int i2, int i3, int i4, int i5, IntByRef intByRef) {
        ...
        if (memcmp(bArr, i, iArr[matchlen], bArr2, i2, i3) < 0) {
            return search(iArr, bArr, i, bArr2, i2, i3, matchlen, i5, intByRef);
        }
        return search(iArr, bArr, i, bArr2, i2, i3, i4, matchlen, intByRef);
    }
    ...
    public static byte[] bsdiff(byte[] bArr, int i, byte[] bArr2, int i2) throws IOException {
        ...
        while (i3 < i2) {
            ...
            int i11 = i3;
            while (i3 < i2) {
                int search = search(iArr, bArr, i, bArr2, i2, i3, 0, i, intByRef);
                int i12 = i11;
                i9 = i10;
                while (i12 < i3 + search) {
            ...
            if (i11 != i9 || i3 == i2) {
                ...
                if (i3 < i2) {
                    ...
                    i9 = 0;
                    i13 = 1;
                    while (i3 >= i6 + i13 && intByRef.value >= i13) {
                        if (bArr[intByRef.value - i13] == bArr2[i3 - i13]) {
                            search++;
                        }
                ...
                if (i6 + i14 > i3 - i15) {
                    ...
                    while (i10 < i4) {
                        ...
                        if (bArr2[(i3 - i15) + i10] == bArr[(intByRef.value - i15) + i10]) {
                            i12 = i9 - 1;
                        } else {
                            i12 = i9;
                        }
                ...
                dataOutputStream2.writeInt((intByRef.value - i9) - (search + i5));
                i4 = intByRef.value - i3;
                i5 = intByRef.value - i9;
                i6 = i3 - i9;
                i7 = i13;
                i8 = i15;
                i9 = i11;
