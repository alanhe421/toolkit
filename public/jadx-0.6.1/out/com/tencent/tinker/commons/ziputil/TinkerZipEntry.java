...
public class TinkerZipEntry implements ZipConstants, Cloneable {
    ...
    TinkerZipEntry(byte[] bArr, InputStream inputStream, Charset charset, boolean z) throws IOException {
        ...
        if (((long) readInt) != 33639248) {
            TinkerZipFile.throwZipException(ConfigBaseParser.DEFAULT_VALUE, (long) inputStream.available(), ConfigBaseParser.DEFAULT_VALUE, 0, "Central Directory Entry", readInt);
        }
        it.seek(8);
    ...
    public long getTime() {
        ...
        gregorianCalendar.set(((this.modDate >> 9) & Opcodes.NEG_FLOAT) + 1980, ((this.modDate >> 5) & 15) - 1, this.modDate & 31, (this.time >> 11) & 31, (this.time >> 5) & 63, (this.time & 31) << 1);
