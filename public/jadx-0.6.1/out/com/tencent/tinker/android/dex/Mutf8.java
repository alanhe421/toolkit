...
public final class Mutf8 {
    ...
    public static String decode(ByteInput byteInput, char[] cArr) throws UTFDataFormatException {
        ...
        while (true) {
            ...
            if (readByte < '') {
                i++;
            } else if ((readByte & Opcodes.SHL_INT_LIT8) == Opcodes.AND_LONG_2ADDR) {
                r4 = byteInput.readByte() & 255;
                if ((r4 & Opcodes.AND_LONG_2ADDR) != 128) {
                    throw new UTFDataFormatException("bad second byte");
                }
                r2 = i + 1;
                cArr[i] = (char) (((readByte & 31) << 6) | (r4 & 63));
                i = r2;
            } else if ((readByte & ETConverter.ET_CONVERTER_GLYPH_CACHE_SIZE_MASK) == Opcodes.SHL_INT_LIT8) {
                r4 = byteInput.readByte() & 255;
                int readByte2 = byteInput.readByte() & 255;
                if ((r4 & Opcodes.AND_LONG_2ADDR) == 128 && (readByte2 & Opcodes.AND_LONG_2ADDR) == 128) {
                    r2 = i + 1;
    ...
    public static void encode(byte[] bArr, int i, String str) {
        ...
        while (i2 < length) {
            ...
            if (charAt != '\u0000' && charAt <= '') {
                ...
                r4 = i + 1;
                bArr[i] = (byte) (((charAt >> 6) & 31) | Opcodes.AND_LONG_2ADDR);
                i3 = r4 + 1;
