...
class s extends WebViewClient {
    ...
    private class e implements WebResourceRequest {
        ...
        public e(s sVar, String str, boolean z, boolean z2, String str2, Map<String, String> map) {
            this.a = sVar;
            this.b = str;
            this.c = z;
            this.d = z2;
    ...
    s(WebView webView, WebViewClient webViewClient) {
        this.b = webView;
    ...
    public void onReceivedError(WebView webView, android.webkit.WebResourceRequest webResourceRequest, WebResourceError webResourceError) {
        com.tencent.smtt.sdk.WebViewClient.a aVar = null;
        this.b.a(webView);
        WebResourceRequest fVar = webResourceRequest != null ? new f(webResourceRequest) : null;
        if (webResourceError != null) {
            aVar = new t(this, webResourceError);
        }
        this.a.onReceivedError(this.b, fVar, aVar);
    }
    ...
    public boolean shouldOverrideUrlLoading(WebView webView, String str) {
        this.b.a(webView);
        return o.a().a(this.b.getContext().getApplicationContext(), str) ? true : this.a.shouldOverrideUrlLoading(this.b, str);
    }
}
