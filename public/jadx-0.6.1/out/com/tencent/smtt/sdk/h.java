...
class h extends X5ProxyWebChromeClient {
    ...
    class a implements QuotaUpdater {
        ...
        a(h hVar, com.tencent.smtt.export.external.interfaces.QuotaUpdater quotaUpdater) {
            this.b = hVar;
            this.a = quotaUpdater;
        }
    ...
    public boolean onCreateWindow(IX5WebViewBase iX5WebViewBase, boolean z, boolean z2, Message message) {
        ...
        Message obtain = Message.obtain(message.getTarget(), new i(this, webView$WebViewTransport, message));
    ...
    public boolean onShowFileChooser(IX5WebViewBase iX5WebViewBase, ValueCallback<Uri[]> valueCallback, IX5WebChromeClient$FileChooserParams iX5WebChromeClient$FileChooserParams) {
        ValueCallback kVar = new k(this, valueCallback);
        FileChooserParams lVar = new l(this, iX5WebChromeClient$FileChooserParams);
        this.a.a(iX5WebViewBase);
        return this.b.onShowFileChooser(this.a, kVar, lVar);
    }

    public void openFileChooser(ValueCallback<Uri[]> valueCallback, String str, String str2, boolean z) {
        this.b.openFileChooser(new j(this, valueCallback), str, str2);
    }
}
