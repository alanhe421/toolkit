...
public class WebSettings {
    ...
    public static String getDefaultUserAgent(Context context) {
        if (aq.a().b() || VERSION.SDK_INT < 17) {
            return null;
        }
        Object a = r.a(android.webkit.WebSettings.class, "getDefaultUserAgent", new Class[]{Context.class}, new Object[]{context});
    ...
    public synchronized boolean getPluginsEnabled() {
        ...
        synchronized (this) {
            if (this.c && this.a != null) {
                ...
                } else if (VERSION.SDK_INT == 18 && PluginState.ON == this.b.getPluginState()) {
                    z = true;
                }
            }
        }
    ...
    public void setAllowContentAccess(boolean z) {
        if (this.c && this.a != null) {
            ...
            r.a(this.b, "setAllowContentAccess", new Class[]{Boolean.TYPE}, new Object[]{Boolean.valueOf(z)});
        }
    }
    ...
    public void setAllowFileAccessFromFileURLs(boolean z) {
        if (this.c && this.a != null) {
            ...
            r.a(this.b, "setAllowFileAccessFromFileURLs", new Class[]{Boolean.TYPE}, new Object[]{Boolean.valueOf(z)});
        }
    }
    ...
    public void setAllowUniversalAccessFromFileURLs(boolean z) {
        if (this.c && this.a != null) {
            ...
            r.a(this.b, "setAllowUniversalAccessFromFileURLs", new Class[]{Boolean.TYPE}, new Object[]{Boolean.valueOf(z)});
        }
    }
    ...
    public void setDatabasePath(String str) {
        if (this.c && this.a != null) {
            ...
            r.a(this.b, "setDatabasePath", new Class[]{String.class}, new Object[]{str});
        }
    }
    ...
    public void setDisplayZoomControls(boolean z) {
        if (this.c && this.a != null) {
            ...
            r.a(this.b, "setDisplayZoomControls", new Class[]{Boolean.TYPE}, new Object[]{Boolean.valueOf(z)});
        }
    }
    ...
    public void setEnableSmoothTransition(boolean z) {
        if (this.c && this.a != null) {
            ...
            r.a(this.b, "setEnableSmoothTransition", new Class[]{Boolean.TYPE}, new Object[]{Boolean.valueOf(z)});
        }
    }
    ...
    public void setMediaPlaybackRequiresUserGesture(boolean z) {
        if (this.c && this.a != null) {
            ...
            r.a(this.b, "setMediaPlaybackRequiresUserGesture", new Class[]{Boolean.TYPE}, new Object[]{Boolean.valueOf(z)});
        }
    }
    ...
    public void setMixedContentMode(int i) {
        if ((!this.c || this.a == null) && !this.c && this.b != null && VERSION.SDK_INT >= 21) {
            r.a(this.b, "setMixedContentMode", new Class[]{Integer.TYPE}, new Object[]{Integer.valueOf(i)});
        }
    }
    ...
    public void setNavDump(boolean z) {
        if (this.c && this.a != null) {
            ...
            r.a(this.b, "setNavDump", new Class[]{Boolean.TYPE}, new Object[]{Boolean.valueOf(z)});
        }
    }
    ...
    public synchronized void setPluginState(PluginState pluginState) {
        if (this.c && this.a != null) {
            ...
            r.a(this.b, "setPluginState", new Class[]{PluginState.class}, new Object[]{valueOf});
        }
    }
    ...
    public void setPluginsEnabled(boolean z) {
        if (this.c && this.a != null) {
            ...
            r.a(this.b, "setPluginsEnabled", new Class[]{Boolean.TYPE}, new Object[]{Boolean.valueOf(z)});
        }
    }
    ...
    public synchronized void setPluginsPath(String str) {
        if (this.c && this.a != null) {
            ...
            r.a(this.b, "setPluginsPath", new Class[]{String.class}, new Object[]{str});
        }
    }

    public void setRenderPriority(RenderPriority renderPriority) {
        if (this.c && this.a != null) {
            this.a.setRenderPriority(RenderPriority.valueOf(renderPriority.name()));
        } else if (!this.c && this.b != null) {
    ...
    public synchronized void setTextZoom(int i) {
        if (this.c && this.a != null) {
            ...
            r.a(this.b, "setTextZoom", new Class[]{Integer.TYPE}, new Object[]{Integer.valueOf(i)});
        }
    }
    ...
    public void setUseWebViewBackgroundForOverscrollBackground(boolean z) {
        if (this.c && this.a != null) {
            ...
            r.a(this.b, "setUseWebViewBackgroundForOverscrollBackground", new Class[]{Boolean.TYPE}, new Object[]{Boolean.valueOf(z)});
        }
    }
