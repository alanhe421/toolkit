...
public class WebView extends FrameLayout implements OnLongClickListener {
    ...
    public static int NIGHT_MODE_ALPHA = Opcodes.SHR_INT;
    ...
    public WebView(Context context, AttributeSet attributeSet, int i, Map<String, Object> map, boolean z) {
        ...
        if (this.f) {
            yVar.a("init_x5_webview", (byte) 1);
            this.g = aq.a().c().a(context);
            yVar.a("init_x5_webview", (byte) 2);
            ...
            this.g.getX5WebViewExtension().setWebViewClientExtension(new aj(this, aq.a().a(true).k()));
            yVar.a("init_all", (byte) 2);
            yVar.a(this.g.hashCode());
        } else {
            this.g = null;
            if (TbsShareManager.isThirdPartyApp(this.j)) {
                this.h = new a(this, context, attributeSet);
    ...
    private boolean a(View view) {
        ...
        Object a = r.a(this.z, "onLongClick", new Class[]{View.class}, new Object[]{view});
    ...
    public static String findAddress(String str) {
        return !aq.a().b() ? android.webkit.WebView.findAddress(str) : null;
    }

    public static String getCrashExtraMessage(Context context) {
        return TbsShareManager.isThirdPartyApp(context) ? "nothing return ^-^." + ("tbs_core_version:" + QbSdk.getTbsVersion(context) + VoiceWakeuperAidl.PARAMS_SEPARATE + "tbs_sdk_version:" + 36801 + VoiceWakeuperAidl.PARAMS_SEPARATE) : new StringBuilder().toString();
    }
    ...
    public static synchronized Object getPluginList() {
        ...
        synchronized (WebView.class) {
            a = !aq.a().b() ? r.a("android.webkit.WebView", "getPluginList") : null;
        }
        return a;
    }
    ...
    public static synchronized void setSysDayOrNight(boolean z) {
        synchronized (WebView.class) {
            if (z != y) {
                ...
                if (x == null) {
                    x = new Paint();
                    x.setColor(NIGHT_MODE_COLOR);
                }
                if (z) {
                    if (x.getAlpha() != 255) {
                        x.setAlpha(255);
                    }
                } else if (x.getAlpha() != NIGHT_MODE_ALPHA) {
                    x.setAlpha(NIGHT_MODE_ALPHA);
                }
            }
        }
    }
    ...
    public static void setWebContentsDebuggingEnabled(boolean z) {
        if (VERSION.SDK_INT >= 19) {
            try {
                q = Class.forName("android.webkit.WebView").getDeclaredMethod("setWebContentsDebuggingEnabled", new Class[]{Boolean.TYPE});
                if (q != null) {
                    q.setAccessible(true);
                    q.invoke(null, new Object[]{Boolean.valueOf(z)});
                }
            } catch (Exception e) {
    ...
    public void addView(View view) {
        if (this.f) {
            ...
            try {
                Method a = r.a(view2, "addView", new Class[]{View.class});
    ...
    public boolean canZoomOut() {
        ...
        Object a = r.a(this.h, "canZoomOut");
        return a == null ? false : ((Boolean) a).booleanValue();
    }
    ...
    public Picture capturePicture() {
        ...
        Object a = r.a(this.h, "capturePicture");
    ...
    public Object createPrintDocumentAdapter(String str) {
        ...
        if (this.f) {
            ...
            return r.a(this.h, "createPrintDocumentAdapter", new Class[]{String.class}, new Object[]{str});
        }
    }
    ...
    public void destroy() {
        if (!(this.l || this.a == 0)) {
            ...
            b.a(this.j, str, str2, str3, this.a, this.f, e());
            this.a = 0;
            this.l = false;
        }
        if (this.f) {
    ...
    public void dumpViewHierarchyWithProperties(BufferedWriter bufferedWriter, int i) {
        ...
        r.a(this.h, "dumpViewHierarchyWithProperties", new Class[]{BufferedWriter.class, Integer.TYPE}, new Object[]{bufferedWriter, Integer.valueOf(i)});
    }
    ...
    public void evaluateJavascript(String str, ValueCallback<String> valueCallback) {
        ...
        if (this.f) {
            try {
                a = r.a(this.g.getView(), "evaluateJavascript", new Class[]{String.class, ValueCallback.class});
                a.setAccessible(true);
    ...
    public int findAll(String str) {
        ...
        Object a = r.a(this.h, "findAll", new Class[]{String.class}, new Object[]{str});
    ...
    public void findAllAsync(String str) {
        if (this.f) {
            ...
            r.a(this.h, "findAllAsync", new Class[]{String.class}, new Object[]{str});
        }
    }
    ...
    public View findHierarchyView(String str, int i) {
        ...
        return (View) r.a(this.h, "findHierarchyView", new Class[]{String.class, Integer.TYPE}, new Object[]{str, Integer.valueOf(i)});
    }
    ...
    public int getContentWidth() {
        ...
        Object a = r.a(this.h, "getContentWidth");
        return a == null ? 0 : ((Integer) a).intValue();
    }
    ...
    public int getVisibleTitleHeight() {
        ...
        Object a = r.a(this.h, "getVisibleTitleHeight");
        return a == null ? 0 : ((Integer) a).intValue();
    }
    ...
    public int getWebScrollY() {
        return this.f ? this.g.getView().getScrollY() : this.h.getScrollY();
    }
    ...
    public View getZoomControls() {
        return !this.f ? (View) r.a(this.h, "getZoomControls") : this.g.getZoomControls();
    }
    ...
    public boolean isPrivateBrowsingEnabled() {
        ...
        Object a = r.a(this.h, "isPrivateBrowsingEnabled");
        return a == null ? false : ((Boolean) a).booleanValue();
    }
    ...
    public boolean onLongClick(View view) {
        return this.A != null ? !this.A.onLongClick(view) ? a(view) : true : a(view);
    }
    ...
    protected void onSizeChanged(int i, int i2, int i3, int i4) {
        ...
        if (VERSION.SDK_INT >= 21 && c(this.j) && isHardwareAccelerated() && i > 0 && i2 > 0 && getLayerType() != 2 && this.g != null && this.g.getView() != null) {
    ...
    protected void onVisibilityChanged(View view, int i) {
        ...
        if (r == null) {
            r = this.j.getApplicationInfo().packageName;
        }
        if (r == null || !(r.equals("com.tencent.mm") || r.equals("com.tencent.mobileqq"))) {
    ...
    public void refreshPlugins(boolean z) {
        ...
        r.a(this.h, "refreshPlugins", new Class[]{Boolean.TYPE}, new Object[]{Boolean.valueOf(z)});
    }
    ...
    public void removeJavascriptInterface(String str) {
        if (!this.f) {
            if (VERSION.SDK_INT >= 11) {
                r.a(this.h, "removeJavascriptInterface", new Class[]{String.class}, new Object[]{str});
                return;
            }
    ...
    public void removeView(View view) {
        if (this.f) {
            View view2 = this.g.getView();
            try {
                Method a = r.a(view2, "removeView", new Class[]{View.class});
                a.setAccessible(true);
                a.invoke(view2, new Object[]{view});
                return;
            } catch (Throwable th) {
    ...
    public boolean restorePicture(Bundle bundle, File file) {
        ...
        Object a = r.a(this.h, "restorePicture", new Class[]{Bundle.class, File.class}, new Object[]{bundle, file});
        return a == null ? false : ((Boolean) a).booleanValue();
    }
    ...
    public void savePassword(String str, String str2, String str3) {
        ...
        r.a(this.h, "savePassword", new Class[]{String.class, String.class, String.class}, new Object[]{str, str2, str3});
    }
    ...
    public boolean savePicture(Bundle bundle, File file) {
        ...
        Object a = r.a(this.h, "savePicture", new Class[]{Bundle.class, File.class}, new Object[]{bundle, file});
        return a == null ? false : ((Boolean) a).booleanValue();
    }
    ...
    public void saveWebArchive(String str) {
        if (this.f) {
            ...
            r.a(this.h, "saveWebArchive", new Class[]{String.class}, new Object[]{str});
        }
    }
    ...
    public void saveWebArchive(String str, boolean z, ValueCallback<String> valueCallback) {
        if (this.f) {
            ...
            r.a(this.h, "saveWebArchive", new Class[]{String.class, Boolean.TYPE, ValueCallback.class}, new Object[]{str, Boolean.valueOf(z), valueCallback});
        }
    }
    ...
    public void setDownloadListener(DownloadListener downloadListener) {
        if (this.f) {
            ...
            this.h.setDownloadListener(new an(this, downloadListener));
        }
    }
    ...
    public void setFindListener(FindListener findListener) {
        if (this.f) {
            ...
            this.h.setFindListener(new am(this, findListener));
        }
    }
    ...
    public void setMapTrackballToArrowKeys(boolean z) {
        ...
        r.a(this.h, "setMapTrackballToArrowKeys", new Class[]{Boolean.TYPE}, new Object[]{Boolean.valueOf(z)});
    }
    ...
    public void setPictureListener(PictureListener pictureListener) {
        if (this.f) {
            if (pictureListener == null) {
                ...
                this.g.setPictureListener(new ap(this, pictureListener));
            }
        } else if (pictureListener == null) {
            this.h.setPictureListener(null);
        } else {
            this.h.setPictureListener(new ao(this, pictureListener));
        }
    }
    ...
    public void setWebChromeClient(WebChromeClient webChromeClient) {
        ...
        if (this.f) {
            ...
            if (webChromeClient != null) {
                hVar = new h(aq.a().a(true).i(), this, webChromeClient);
            }
    ...
    public void setWebViewClient(WebViewClient webViewClient) {
        ...
        if (this.f) {
            ...
            if (webViewClient != null) {
                mVar = new m(aq.a().a(true).j(), this, webViewClient);
            }
        ...
        android.webkit.WebView webView = this.h;
        if (webViewClient != null) {
            webViewClient2 = new s(this, webViewClient);
        }
    ...
    public boolean showDebugView(String str) {
        ...
        c.a(this.j).a(str, this, this.j, x.a().getLooper());
        return true;
    }
    ...
    public void super_computeScroll() {
        if (this.f) {
            try {
                r.a(this.g.getView(), "super_computeScroll");
                return;
            } catch (Throwable th) {
                th.printStackTrace();
                return;
    ...
    public boolean super_dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        try {
            Object a = r.a(this.g.getView(), "super_dispatchTouchEvent", new Class[]{MotionEvent.class}, new Object[]{motionEvent});
            return a == null ? false : ((Boolean) a).booleanValue();
        } catch (Throwable th) {
            return false;
        }
    ...
    public boolean super_onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        try {
            Object a = r.a(this.g.getView(), "super_onInterceptTouchEvent", new Class[]{MotionEvent.class}, new Object[]{motionEvent});
            return a == null ? false : ((Boolean) a).booleanValue();
        } catch (Throwable th) {
            return false;
        }
    ...
    public void super_onOverScrolled(int i, int i2, boolean z, boolean z2) {
        if (this.f) {
            try {
                r.a(this.g.getView(), "super_onOverScrolled", new Class[]{Integer.TYPE, Integer.TYPE, Boolean.TYPE, Boolean.TYPE}, new Object[]{Integer.valueOf(i), Integer.valueOf(i2), Boolean.valueOf(z), Boolean.valueOf(z2)});
                return;
            } catch (Throwable th) {
                th.printStackTrace();
                return;
    ...
    public void super_onScrollChanged(int i, int i2, int i3, int i4) {
        if (this.f) {
            try {
                r.a(this.g.getView(), "super_onScrollChanged", new Class[]{Integer.TYPE, Integer.TYPE, Integer.TYPE, Integer.TYPE}, new Object[]{Integer.valueOf(i), Integer.valueOf(i2), Integer.valueOf(i3), Integer.valueOf(i4)});
                return;
            } catch (Throwable th) {
                th.printStackTrace();
                return;
    ...
    public boolean super_onTouchEvent(MotionEvent motionEvent) {
        ...
        try {
            Object a = r.a(this.g.getView(), "super_onTouchEvent", new Class[]{MotionEvent.class}, new Object[]{motionEvent});
            return a == null ? false : ((Boolean) a).booleanValue();
        } catch (Throwable th) {
            return false;
        }
    ...
    public boolean super_overScrollBy(int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, boolean z) {
        ...
        try {
            Object a = r.a(this.g.getView(), "super_overScrollBy", new Class[]{Integer.TYPE, Integer.TYPE, Integer.TYPE, Integer.TYPE, Integer.TYPE, Integer.TYPE, Integer.TYPE, Integer.TYPE, Boolean.TYPE}, new Object[]{Integer.valueOf(i), Integer.valueOf(i2), Integer.valueOf(i3), Integer.valueOf(i4), Integer.valueOf(i5), Integer.valueOf(i6), Integer.valueOf(i7), Integer.valueOf(i8), Boolean.valueOf(z)});
            return a == null ? false : ((Boolean) a).booleanValue();
        } catch (Throwable th) {
            return false;
        }
