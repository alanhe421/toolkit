...
class m extends X5ProxyWebViewClient {
    private static String c = null;
    private WebViewClient a;
    private WebView b;

    public m(IX5WebViewClient iX5WebViewClient, WebView webView, WebViewClient webViewClient) {
    ...
    public boolean shouldOverrideUrlLoading(IX5WebViewBase iX5WebViewBase, String str) {
        this.b.a(iX5WebViewBase);
        if (o.a().a(this.b.getContext().getApplicationContext(), str)) {
            return true;
        }
