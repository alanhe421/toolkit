...
public class c {
    ...
    private c(Context context) {
        this.a = context.getDir("debugtbs", 0).getAbsolutePath() + File.separator + DLConstants.PLUGIN;
    }
    ...
    public void a(String str, WebView webView, Context context) {
        ...
        i.a(new File(str2));
        a(str2, new d(this, webView, context, relativeLayout, str, textView));
    }
    ...
    public void a(String str, WebView webView, Context context, Looper looper) {
        ...
        if (file2.exists()) {
            try {
                str2 = "";
                str2 = a.a(context, new File(str3));
