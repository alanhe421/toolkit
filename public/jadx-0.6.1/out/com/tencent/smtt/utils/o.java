...
public class o {
        ...
        try {
            ...
            if (!TextUtils.isEmpty(e)) {
                ...
                if (file.exists()) {
                    ...
                    q.a(context).a(context.getApplicationInfo().processName);
                }
            }
        } catch (Throwable th) {
            th.printStackTrace();
    ...
    private Map<String, String> d(Context context) {
        ...
        try {
            ...
            if (file == null || !file.exists()) {
                ...
                try {
                    byte[] b = i.b((InputStream) fileInputStream2);
                    if (b != null) {
    ...
    private String e(Context context) {
        ...
        if (d != null && d.size() > 0) {
            ...
            if (TextUtils.equals(l.a(file.lastModified() + ""), str2)) {
                return str;
            }
        }
        return "";
            ...
            try {
                if (str.startsWith("tbsqbdownload://")) {
                    ...
                    if (split.length > 1) {
                        ...
                        substring = (split2.length <= 1 || !SocialConstants.PARAM_URL.equalsIgnoreCase(split2[0])) ? null : split[0].substring(SocialConstants.PARAM_URL.length() + 1);
