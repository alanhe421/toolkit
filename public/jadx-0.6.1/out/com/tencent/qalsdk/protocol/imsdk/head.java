...
public final class head {
    ...
    public static final class InstInfo extends MessageMicro<InstInfo> {
        ...
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 16, 24, 32, 40, 48, 58, 64, 72, 80}, new String[]{"uint32_apppid", "uint32_instid", "uint32_platform", "uint32_open_appid", "uint32_productid", "uint32_sso_bid", "bytes_guid", "uint32_ver_min", "uint32_ver_max", "enum_device_type"}, new Object[]{Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), ByteStringMicro.EMPTY, Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(1)}, InstInfo.class);
    ...
    public static final class UinExtaInfo extends MessageMicro<UinExtaInfo> {
        ...
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 16, 26, 34, 42}, new String[]{"uint32_msg_flag", "uint32_role", "bytes_name_card", "rpt_msg_app_defined_data_account", "rpt_msg_app_defined_data_group_member"}, new Object[]{Integer.valueOf(0), Integer.valueOf(0), ByteStringMicro.EMPTY, null, null}, UinExtaInfo.class);
