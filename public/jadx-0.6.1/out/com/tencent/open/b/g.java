                ...
                this.g.execute(new Runnable(this) {
                    ...
                    public void run() {
                        try {
                            ...
                            bundle.putString(MidEntity.TAG_IMEI, c.b(Global.getContext()));
                            bundle.putString(MidEntity.TAG_IMSI, c.c(Global.getContext()));
                            ...
                            bundle.putString(ComicStoreExclusiveItemCard.NET_AD_ATTR_POSITION, Util.getLocation(Global.getContext()));
