...
public final class im_open_common {
    ...
    public static final class IMUserId extends MessageMicro<IMUserId> {
        ...
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{10, 16, 26, 32, 40}, new String[]{"uidtype", "userappid", "userid", "tinyid", "uin"}, new Object[]{ByteStringMicro.EMPTY, Integer.valueOf(0), ByteStringMicro.EMPTY, Long.valueOf(0), Long.valueOf(0)}, IMUserId.class);
    ...
    public static final class UserStatus extends MessageMicro<UserStatus> {
        ...
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{10, 16, 24}, new String[]{"openid", "status", "network_type"}, new Object[]{ByteStringMicro.EMPTY, Integer.valueOf(0), Integer.valueOf(0)}, UserStatus.class);
