...
public final class stat_settoken {
    ...
    public static final class ReqBody extends MessageMicro<ReqBody> {
        ...
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{10, 18, 24, 32, 40, 48, 56, 64, 74, 82, 90, 96, 104}, new String[]{"bytes_token_id", "str_extends", "uint32_push_msg", "uint32_push_zone", "uint32_online_push", "uint32_enter_version", "uint32_photo_push", "uint32_push_without_content", "str_push_sound", "str_empty_sound", "str_video_sound", "uint32_busiid", "uint32_inst_type"}, new Object[]{ByteStringMicro.EMPTY, "", Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), "", "", "", Integer.valueOf(0), Integer.valueOf(0)}, ReqBody.class);
