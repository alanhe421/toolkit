...
public final class msgcomm {
    ...
    public static final class MsgElement extends MessageMicro<MsgElement> {
        ...
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{10, 18}, new String[]{"MsgType", "MsgContent"}, new Object[]{"", ""}, MsgElement.class);
    ...
    public static final class MsgInfo extends MessageMicro<MsgInfo> {
        ...
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{10, 16, 26, 32, 40, 48, 58, 64}, new String[]{"FromOpenid", "FromTinyid", "ToOpenid", "ToTinyid", "MsgTimestamp", "MsgSeqId", "Msg", "MsgReaded"}, new Object[]{"", Long.valueOf(0), "", Long.valueOf(0), Integer.valueOf(0), Long.valueOf(0), null, Integer.valueOf(0)}, MsgInfo.class);
    ...
    public static final class UserInfo extends MessageMicro<UserInfo> {
        ...
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{10, 16, 26, 34, 42}, new String[]{"Openid", "Tinyid", "HeadURL", SenderProfile.KEY_NICKNAME, "Remark"}, new Object[]{"", Long.valueOf(0), "", "", ""}, UserInfo.class);
