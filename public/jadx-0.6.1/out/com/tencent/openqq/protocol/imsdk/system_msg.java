...
public final class system_msg {
    ...
    public static final class InviteQQToMultiSharp extends MessageMicro<InviteQQToMultiSharp> {
        ...
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 16}, new String[]{"uint64_conf_code", "rpt_uint64_uin_list"}, new Object[]{Long.valueOf(0), Long.valueOf(0)}, InviteQQToMultiSharp.class);
