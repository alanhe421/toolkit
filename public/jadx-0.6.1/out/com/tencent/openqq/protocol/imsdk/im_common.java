...
public final class im_common {
    ...
    public static final class BladeSoulToken extends MessageMicro<BladeSoulToken> {
        ...
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 16, 24, 32, 40}, new String[]{"key_ver", "uin", "app_id", "key_time", "random"}, new Object[]{Integer.valueOf(0), Long.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0)}, BladeSoulToken.class);
    ...
    public static final class Signature extends MessageMicro<Signature> {
        ...
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 16, 26}, new String[]{"key_type", "session_app_id", "session_key"}, new Object[]{Integer.valueOf(0), Integer.valueOf(0), ByteStringMicro.EMPTY}, Signature.class);
    ...
    public static final class Token extends MessageMicro<Token> {
        ...
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{10, 16, 24, 34}, new String[]{"buf", "c2c_type", "service_type", "bytes_sigt"}, new Object[]{ByteStringMicro.EMPTY, Integer.valueOf(0), Integer.valueOf(0), ByteStringMicro.EMPTY}, Token.class);
    ...
    public static final class User extends MessageMicro<User> {
        ...
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 16, 24, 32, 45, 48, 58, 64, 72, 82}, new String[]{"uin", "app_id", "instance_id", "app_type", "client_ip", ComicStoreExclusiveItemCard.NET_AD_ATTR_VERSION, "str_phone_number", "platform_id", "language", "equip_key"}, new Object[]{Long.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), "", Integer.valueOf(0), Integer.valueOf(0), ByteStringMicro.EMPTY}, User.class);
        public final PBUInt32Field app_id = PBField.initUInt32(0);
