...
public final class group_video_info {
    ...
    public static final class VideoRecordRes extends MessageMicro<VideoRecordRes> {
        ...
        public static final int UINT32_RESULT_FIELD_NUMBER = 1;
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 18, 26}, new String[]{"uint32_result", "str_errorinfo", "str_fileID"}, new Object[]{Integer.valueOf(0), "", ""}, VideoRecordRes.class);
        public final PBStringField str_errorinfo = PBField.initString("");
