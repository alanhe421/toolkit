...
public final class quality_report {
    ...
    public static final class DeviceInfo extends MessageMicro<DeviceInfo> {
        ...
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 18, 26, 34, 42}, new String[]{"enum_device_type", "str_device_brand", "str_device_model", "str_device_board", "str_device_cpu_abi"}, new Object[]{Integer.valueOf(1), "", "", "", ""}, DeviceInfo.class);
    ...
    public static final class ReqBody extends MessageMicro<ReqBody> {
        ...
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 16, 24, 32, 42, 50}, new String[]{"uint32_sdkappid", "uint64_from_uin", "uint32_timestamp", "uint32_seq", "msg_common_info", "msg_report_content"}, new Object[]{Integer.valueOf(0), Long.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), null, null}, ReqBody.class);
