...
public final class log_upload_pb {
    ...
    public static final class MsgBody extends MessageMicro<MsgBody> {
        ...
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 18, 26, 34, 40, 50}, new String[]{"rpt_uint64_logtime", "rpt_string_logtime", "rpt_string_tag", "bytes_log_id", "uint32_log_size", "bytes_log_path"}, new Object[]{Long.valueOf(0), "", "", ByteStringMicro.EMPTY, Integer.valueOf(0), ByteStringMicro.EMPTY}, MsgBody.class);
