...
public final class head {
    ...
    public static final class AnyConnC2CInfo extends MessageMicro<AnyConnC2CInfo> {
        ...
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 16, 24, 32}, new String[]{"uint64_from_uin", "uint64_to_uin", "enum_from_node_type", "enum_to_node_type"}, new Object[]{Long.valueOf(0), Long.valueOf(0), Integer.valueOf(1), Integer.valueOf(1)}, AnyConnC2CInfo.class);
    ...
    public static final class C2CInfo extends MessageMicro<C2CInfo> {
        ...
        public static final int UINT64_TO_UIN_FIELD_NUMBER = 2;
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 16, 26, 32, 40, 48, 56, 64, 74, 82, 88, 96}, new String[]{"uint64_from_uin", "uint64_to_uin", "bytes_from_uin_nick", "uint64_from_uin_binded", "enum_from_uin_type", "enum_to_uin_type", "uint64_to_uin_binded", "uint32_from_indentity_for_client", "msg_from_phoneinfo", "msg_to_phoneinfo", "enum_to_domain", "enum_to_uin_binded_type"}, new Object[]{Long.valueOf(0), Long.valueOf(0), ByteStringMicro.EMPTY, Long.valueOf(0), Integer.valueOf(1), Integer.valueOf(1), Long.valueOf(0), Integer.valueOf(0), null, null, Integer.valueOf(1), Integer.valueOf(1)}, C2CInfo.class);
    ...
    public static final class C2SInfo extends MessageMicro<C2SInfo> {
        ...
        public static final int ENUM_FROM_UIN_TYPE_FIELD_NUMBER = 3;
        public static final int UINT64_FROM_UIN_FIELD_NUMBER = 1;
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 16, 24}, new String[]{"uint64_from_uin", "enum_dest_svr_type", "enum_from_uin_type"}, new Object[]{Long.valueOf(0), Integer.valueOf(1), Integer.valueOf(1)}, C2SInfo.class);
    ...
    public static final class CSHead extends MessageMicro<CSHead> {
        ...
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 16, 24, 32, 40, 48, 56, 64, 72, 85, 88, 101, 104, Opcodes.INVOKE_SUPER_RANGE, 120, Opcodes.LONG_TO_FLOAT, Opcodes.FLOAT_TO_LONG, Opcodes.AND_INT, Opcodes.SHL_INT, 160, Opcodes.MUL_FLOAT, Opcodes.ADD_INT_2ADDR, Opcodes.SHL_INT_2ADDR, Opcodes.AND_LONG_2ADDR}, new String[]{"uint64_uin", "uint32_command", "uint32_seq", "uint32_version", "uint32_retry_times", "uint32_client_type", "uint32_pubno", "uint32_localid", "uint32_timezone", "uint32_client_ip", "uint32_client_port", "uint32_conn_ip", "uint32_conn_port", "uint32_interface_ip", "uint32_interface_port", "uint32_actual_ip", "uint32_flag", "uint32_timestamp", "uint32_subcmd", "uint32_result", "uint32_app_id", "uint32_instance_id", "uint64_session_id", "uint32_idc_id"}, new Object[]{Long.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Long.valueOf(0), Integer.valueOf(0)}, CSHead.class);
    ...
    public static final class ConfInfo extends MessageMicro<ConfInfo> {
        ...
        public static final int UINT64_FROM_UIN_FIELD_NUMBER = 1;
        public static final int UINT64_TO_UIN_FIELD_NUMBER = 2;
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 16, 24, 32, 42, 48, 56, 66, 74, 82}, new String[]{"uint64_from_uin", "uint64_to_uin", "enum_from_uin_type", "enum_to_uin_type", "bytes_from_uin_nick", "uint64_conf_uin", "uint32_from_uin_image_id", "bytes_conf_name", "bytes_to_phone_number", "bytes_combined_conf_name"}, new Object[]{Long.valueOf(0), Long.valueOf(0), Integer.valueOf(1), Integer.valueOf(1), ByteStringMicro.EMPTY, Long.valueOf(0), Integer.valueOf(0), ByteStringMicro.EMPTY, ByteStringMicro.EMPTY, ByteStringMicro.EMPTY}, ConfInfo.class);
    ...
    public static final class DeltaHead extends MessageMicro<DeltaHead> {
        ...
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 16, 24, 34, 42, 48, 56}, new String[]{"uint64_total_len", "uint64_offset", "uint64_ack_offset", "bytes_cookie", "bytes_ack_cookie", "uint32_result", "uint32_flags"}, new Object[]{Long.valueOf(0), Long.valueOf(0), Long.valueOf(0), ByteStringMicro.EMPTY, ByteStringMicro.EMPTY, Integer.valueOf(0), Integer.valueOf(0)}, DeltaHead.class);
    ...
    public static final class GroupInfo extends MessageMicro<GroupInfo> {
        ...
        public static final int UINT64_TO_UIN_FIELD_NUMBER = 2;
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 16, 24, 32, 42, 48, 56, 66, 72, 80, 90, 98, 104, 114}, new String[]{"uint64_from_uin", "uint64_to_uin", "enum_from_uin_type", "enum_to_uin_type", "bytes_from_uin_nick", "uint64_group_uin", "uint64_group_code", "bytes_group_name", "uint64_from_uin_binded", "uint64_to_uin_binded", "bytes_from_uin_headurl", "bytes_group_id", "uint32_msg_flag", "msg_from_uin_extra_info"}, new Object[]{Long.valueOf(0), Long.valueOf(0), Integer.valueOf(1), Integer.valueOf(1), ByteStringMicro.EMPTY, Long.valueOf(0), Long.valueOf(0), ByteStringMicro.EMPTY, Long.valueOf(0), Long.valueOf(0), ByteStringMicro.EMPTY, ByteStringMicro.EMPTY, Integer.valueOf(0), null}, GroupInfo.class);
    ...
    public static final class HttpConnHead extends MessageMicro<HttpConnHead> {
        ...
        public static final int UINT64_UIN_FIELD_NUMBER = 1;
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 16, 24, 32, 40, 48, 56, 64, 72, 80, 93, 96, 109, 112, Opcodes.NEG_LONG, 128, Opcodes.FLOAT_TO_LONG, Opcodes.MUL_INT, Opcodes.SHL_INT, 160, Opcodes.MUL_FLOAT, Opcodes.MUL_INT_2ADDR}, new String[]{"uint64_uin", "uint32_command", "uint32_sub_command", "uint32_seq", "uint32_version", "uint32_retry_times", "uint32_client_type", "uint32_pub_no", "uint32_local_id", "uint32_time_zone", "uint32_client_ip", "uint32_client_port", "uint32_qzhttp_ip", "uint32_qzhttp_port", "uint32_spp_ip", "uint32_spp_port", "uint32_flag", "bytes_key", "uint32_compress_type", "uint32_origin_size", "uint32_error_code", "msg_redirect"}, new Object[]{Long.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), ByteStringMicro.EMPTY, Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), null}, HttpConnHead.class);
        public final PBBytesField bytes_key = PBField.initBytes(ByteStringMicro.EMPTY);
    ...
    public static final class LoginSig extends MessageMicro<LoginSig> {
        ...
        public static final int UINT32_TYPE_FIELD_NUMBER = 1;
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 18, 24}, new String[]{"uint32_type", "bytes_sig", "uint32_app_id"}, new Object[]{Integer.valueOf(0), ByteStringMicro.EMPTY, Integer.valueOf(0)}, LoginSig.class);
    ...
    public static final class MsgDestroyTimeInfo extends MessageMicro<MsgDestroyTimeInfo> {
        ...
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 16, 24, 32}, new String[]{"uint32_time_length", "uint32_set_time", "uint64_set_qcallid", "uint32_set_time_us"}, new Object[]{Integer.valueOf(0), Integer.valueOf(0), Long.valueOf(0), Integer.valueOf(0)}, MsgDestroyTimeInfo.class);
    ...
    public static final class MsgExtraInfo extends MessageMicro<MsgExtraInfo> {
        ...
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 16, 26, 34, 40, 48, 56, 66, 72, 80, 90, 98, 104, 114, 122, 128}, new String[]{"uint32_notify_flag", "uint32_msg_lifetime", "msg_destroy_time_config", "msg_uin_extra_info", "uint32_place_msg", "uint32_msg_compatibility_type", "uint32_sync_from_old_system", "msg_encrypt_info", "uint32_mutli_inst_sync", "uint32_msg_priority", "bytes_identifier", "bytes_from_uin_nick", "uint64_stat_flag", "msg_offline_push_info", "bytes_push_task_id", "uint64_msg_id_crc"}, new Object[]{Integer.valueOf(0), Integer.valueOf(0), null, null, Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), null, Integer.valueOf(0), Integer.valueOf(0), ByteStringMicro.EMPTY, ByteStringMicro.EMPTY, Long.valueOf(0), null, ByteStringMicro.EMPTY, Long.valueOf(0)}, MsgExtraInfo.class);
        public final PBBytesField bytes_from_uin_nick = PBField.initBytes(ByteStringMicro.EMPTY);
    ...
    public static final class MsgTransInfo extends MessageMicro<MsgTransInfo> {
        ...
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 16, 26}, new String[]{"trans_type", "trans_code", "trans_msg"}, new Object[]{Integer.valueOf(0), Integer.valueOf(0), ByteStringMicro.EMPTY}, MsgTransInfo.class);
    ...
    public static final class QQLoginSig extends MessageMicro<QQLoginSig> {
        ...
        public static final int UINT64_UIN_FIELD_NUMBER = 1;
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 16, 26, 32}, new String[]{"uint64_uin", "uint32_type", "bytes_sig", "uint32_appid"}, new Object[]{Long.valueOf(0), Integer.valueOf(0), ByteStringMicro.EMPTY, Integer.valueOf(0)}, QQLoginSig.class);
        public final PBBytesField bytes_sig = PBField.initBytes(ByteStringMicro.EMPTY);
    ...
    public static final class Signature extends MessageMicro<Signature> {
        ...
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 16, 26}, new String[]{"uint32_key_type", "uint32_session_app_id", "bytes_session_key"}, new Object[]{Integer.valueOf(0), Integer.valueOf(0), ByteStringMicro.EMPTY}, Signature.class);
    ...
    public static final class TermInfo extends MessageMicro<TermInfo> {
        ...
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 16, 24, 32, 40}, new String[]{"product", "device", "os", "version_no", "version_id"}, new Object[]{Integer.valueOf(1), Integer.valueOf(1), Integer.valueOf(1), Integer.valueOf(0), Integer.valueOf(0)}, TermInfo.class);
    ...
    public static final class TmpMsgToken extends MessageMicro<TmpMsgToken> {
        ...
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{10, 16, 24}, new String[]{"bytes_buf", "uint32_c2c_type", "uint32_service_type"}, new Object[]{ByteStringMicro.EMPTY, Integer.valueOf(0), Integer.valueOf(0)}, TmpMsgToken.class);
