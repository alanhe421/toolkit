...
public final class log_report {
    ...
    public static final class ReqBody extends MessageMicro<ReqBody> {
        ...
        static final FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 18, 26}, new String[]{"uint32_err_code", "bytes_err_msg", "bytes_log_id"}, new Object[]{Integer.valueOf(0), ByteStringMicro.EMPTY, ByteStringMicro.EMPTY}, ReqBody.class);
