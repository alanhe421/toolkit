    ...
    public void shareToQzone(final Activity activity, final Bundle bundle, final IUiListener iUiListener) {
        ...
        if (Util.hasSDCard() || SystemUtils.compareQQVersion(activity, SystemUtils.QQ_VERSION_NAME_4_5_0) >= 0) {
            ...
            if (this.b) {
                ...
                if (!Util.isEmpty(string2) && string2.length() > ErrorCode.INFO_STATIC_TBS_INSTALL_ERR_CODE_BASE) {
                    bundle.putString("summary", Util.subString(string2, ErrorCode.INFO_STATIC_TBS_INSTALL_ERR_CODE_BASE, null, null));
                }
            }
