...
public class AuthAgent extends BaseApi {
    ...
    private class FeedConfirmListener implements IUiListener {
        ...
        protected void a() {
            ...
            Activity activity = (Activity) this.b.c.get();
            if (activity != null) {
                HttpUtils.requestAsync(this.b.mToken, activity, "http://appsupport.qq.com/cgi-bin/qzapps/mapp_addapp.cgi", g, Constants.HTTP_POST, null);
            }
        }
    ...
    static {
        ...
        } else if (str.equalsIgnoreCase(DLConstants.CPU_X86)) {
    ...
    private int a(boolean z, IUiListener iUiListener) {
        ...
        composeCGIParams.putString("response_type", com.tencent.android.tpush.common.Constants.FLAG_TOKEN);
