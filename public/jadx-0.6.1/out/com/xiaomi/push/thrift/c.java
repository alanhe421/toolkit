...
public class c implements Serializable, Cloneable, org.apache.thrift.a<c, a> {
    ...
    private static final org.apache.thrift.protocol.b f = new org.apache.thrift.protocol.b("uuid", JceStruct.STRUCT_END, (short) 1);
    private static final org.apache.thrift.protocol.b g = new org.apache.thrift.protocol.b("operator", JceStruct.STRUCT_END, (short) 2);
    ...
    static {
        ...
        enumMap.put(a.UUID, new b("uuid", (byte) 1, new org.apache.thrift.meta_data.c(JceStruct.STRUCT_END)));
        enumMap.put(a.OPERATOR, new b("operator", (byte) 2, new org.apache.thrift.meta_data.c(JceStruct.STRUCT_END)));
        enumMap.put(a.EVENTS, new b("events", (byte) 1, new d((byte) 15, new g(JceStruct.ZERO_TAG, b.class))));
    ...
    public void b(e eVar) {
        ...
        if (this.c != null) {
            eVar.a(h);
            eVar.a(new org.apache.thrift.protocol.c(JceStruct.ZERO_TAG, this.c.size()));
            for (b b : this.c) {
                b.b(eVar);
            }
            eVar.e();
