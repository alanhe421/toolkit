...
public class am {
    ...
    public static class b {
        ...
        public void a(c cVar, int i, int i2, String str, String str2) {
            ...
            if (this.m != cVar) {
                com.xiaomi.channel.commonutils.b.c.a(String.format("update the client %7$s status. %1$s->%2$s %3$s %4$s %5$s %6$s", new Object[]{this.m, cVar, a(i), o.a(i2), str, str2, this.h}));
                this.m = cVar;
            }
            if (this.k == null) {
                com.xiaomi.channel.commonutils.b.c.d("status changed while the client dispatcher is missing");
            } else if (i == 2) {
