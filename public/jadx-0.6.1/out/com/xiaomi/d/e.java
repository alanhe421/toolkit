...
public class e implements d {
    ...
    e(XMPushService xMPushService) {
        ...
        this.e = com.xiaomi.channel.commonutils.d.d.l(xMPushService);
        c();
    ...
    private void c() {
        ...
        if (com.xiaomi.channel.commonutils.d.d.d(this.a)) {
    ...
    public void a(a aVar, int i, Exception exception) {
        ...
        c.c("Stats rx=" + (uidRxBytes - this.k) + ", tx=" + (g - this.j));
        this.k = uidRxBytes;
        this.j = g;
    }

    public void a(a aVar, Exception exception) {
        h.a(0, com.xiaomi.push.thrift.a.CHANNEL_CON_FAIL.a(), 1, aVar.d(), com.xiaomi.channel.commonutils.d.d.d(this.a) ? 1 : 0);
        b();
    }

    public synchronized void b() {
        if (this.a != null) {
            Object l = com.xiaomi.channel.commonutils.d.d.l(this.a);
            boolean d = com.xiaomi.channel.commonutils.d.d.d(this.a);
            long elapsedRealtime = SystemClock.elapsedRealtime();
            if (this.f > 0) {
