...
public abstract class h extends a {
    ...
    private void a(java.lang.String r17, int r18) {
        ...
        r2 = r2.append(r0);
        r2 = r2.toString();
        r2 = com.xiaomi.channel.commonutils.b.c.e(r2);
        r5 = r2.intValue();
        r2 = r16.b(r17);
        r5 = java.lang.Integer.valueOf(r5);
        com.xiaomi.channel.commonutils.b.c.a(r5);
    ...
    L_0x0046:
        ...
        r0 = r16;
        r5 = r0.s;
        r10 = com.xiaomi.channel.commonutils.d.d.l(r5);
    ...
    L_0x0063:
        ...
        com.xiaomi.channel.commonutils.b.c.a(r5);	 Catch:{ IOException -> 0x0114, l -> 0x0185, Throwable -> 0x01f4 }
        r5 = r16.t();	 Catch:{ IOException -> 0x0114, l -> 0x0185, Throwable -> 0x01f4 }
        r0 = r16;
        r0.q = r5;	 Catch:{ IOException -> 0x0114, l -> 0x0185, Throwable -> 0x01f4 }
        r0 = r18;
        r5 = com.xiaomi.network.d.b(r3, r0);	 Catch:{ IOException -> 0x0114, l -> 0x0185, Throwable -> 0x01f4 }
        r0 = r16;
        ...
        r16.b();	 Catch:{ IOException -> 0x0114, l -> 0x0185, Throwable -> 0x01f4 }
        r9 = 1;
    ...
    L_0x00d3:
        ...
        com.xiaomi.channel.commonutils.b.c.a(r4);	 Catch:{ IOException -> 0x0242, l -> 0x023f, Throwable -> 0x023b }
    L_0x0101:
        r2 = com.xiaomi.network.f.a();
        r2.h();
    ...
    L_0x0122:
        ...
        com.xiaomi.channel.commonutils.b.c.d(r4);	 Catch:{ all -> 0x0239 }
    ...
    L_0x016c:
        r0 = r16;
        r4 = r0.p;
        com.xiaomi.d.h.a(r3, r4);
        r0 = r16;
        r3 = r0.s;
        r3 = com.xiaomi.channel.commonutils.d.d.l(r3);
    ...
    L_0x01f5:
        ...
        com.xiaomi.channel.commonutils.b.c.a(r5);	 Catch:{ all -> 0x021e }
        if (r4 != 0) goto L_0x0245;
    L_0x0206:
        r0 = r16;
        r5 = r0.p;
        com.xiaomi.d.h.a(r3, r5);
        r0 = r16;
        r3 = r0.s;
        r3 = com.xiaomi.channel.commonutils.d.d.l(r3);
        r3 = android.text.TextUtils.equals(r10, r3);
    ...
    protected void a(Exception exception) {
        if (SystemClock.elapsedRealtime() - this.v >= TaskManager.IDLE_PROTECT_TIME) {
            this.x = 0;
        } else if (d.d(this.s)) {
            this.x++;
            if (this.x >= 2) {
                String d = d();
                c.a("max short conn time reached, sink down current host:" + d);
                a(d, 0, exception);
                this.x = 0;
            }
        }
    ...
    b b(String str) {
        ...
        this.f = 0;
        try {
            byte[] address = InetAddress.getByName(a.f).getAddress();
            this.f = address[0] & 255;
            this.f |= (address[1] << 8) & 65280;
            this.f |= (address[2] << 16) & 16711680;
            this.f = ((address[3] << 24) & WebView.NIGHT_MODE_COLOR) | this.f;
    ...
    public void b(boolean z) {
        ...
        a(z);
        if (!z) {
            this.s.a(new i(this, 13, currentTimeMillis), (long) TracerConfig.LOG_FLUSH_DURATION);
        }
    }
