...
public class a {
    ...
    public static com.xiaomi.smack.packet.a a(String str, String str2, XmlPullParser xmlPullParser) {
        ...
        return (a == null || !(a instanceof ap)) ? null : ((ap) a).b(xmlPullParser);
    }
    ...
    public static b a(XmlPullParser xmlPullParser, com.xiaomi.smack.a aVar) {
        ...
        if (bVar == null) {
            if (b$a.a == a || b$a.b == a) {
                ...
                aVar.a(bVar3);
                com.xiaomi.channel.commonutils.b.c.d("iq usage error. send packet in packet parser.");
                return null;
            }
            bVar = new c();
        }
    ...
    public static d a(XmlPullParser xmlPullParser) {
        ...
        if ("1".equals(xmlPullParser.getAttributeValue("", "s"))) {
            ...
            am.b b2 = b == null ? am.a().b(attributeValue, attributeValue3) : b;
            if (b2 == null) {
            ...
            while (!z) {
                ...
                if (next == 2) {
                    if (!"s".equals(xmlPullParser.getName())) {
                        ...
                        a(s.b(s.a(b2.i, attributeValue2), text));
                        a.next();
                        dVar = a(a);
                    }
