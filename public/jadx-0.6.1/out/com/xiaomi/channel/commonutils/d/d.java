...
public class d {
    ...
    public static com.xiaomi.channel.commonutils.d.b a(android.content.Context r9, java.lang.String r10, java.lang.String r11, java.util.Map<java.lang.String, java.lang.String> r12, java.lang.String r13) {
        /*
        r3 = 0;
        r2 = 0;
        r5 = new com.xiaomi.channel.commonutils.d.b;
        r5.<init>();
    ...
    L_0x00a0:
        ...
        r3 = new com.xiaomi.channel.commonutils.d.d$a;	 Catch:{ IOException -> 0x00da, Throwable -> 0x00ef, all -> 0x012a }
    ...
    L_0x00da:
        ...
        r3 = new com.xiaomi.channel.commonutils.d.d$a;	 Catch:{ IOException -> 0x0041, Throwable -> 0x00ef, all -> 0x012a }
    ...
    L_0x0144:
        ...
        goto L_0x0071;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.xiaomi.channel.commonutils.d.d.a(android.content.Context, java.lang.String, java.lang.String, java.util.Map, java.lang.String):com.xiaomi.channel.commonutils.d.b");
    }
    ...
    public static InputStream a(Context context, URL url, boolean z, String str, String str2, Map<String, String> map, b bVar) {
        if (context == null) {
            ...
            try {
                ...
                b.setConnectTimeout(com.tencent.android.tpush.common.Constants.ERRORCODE_UNKNOWN);
                ...
                if (bVar != null) {
                    if (url.getProtocol().equals(c.d) || url.getProtocol().equals("https")) {
    ...
    public static String a(String str) {
        ...
        return String.format("%s&key=%s", new Object[]{str, com.xiaomi.channel.commonutils.g.c.a(str2)});
    }
    ...
    public static boolean b(Context context) {
        ...
        try {
            ...
            try {
                ...
                return (TextUtils.isEmpty(extraInfo) || extraInfo.length() < 3 || extraInfo.contains(APNName.NAME_CTWAP)) ? false : extraInfo.regionMatches(true, extraInfo.length() - 3, "wap", 0, 3);
            } catch (Exception e) {
                return false;
            }
        } catch (Exception e2) {
    ...
    public static boolean c(Context context) {
        ...
        try {
            ...
            try {
                ...
                String extraInfo = activeNetworkInfo.getExtraInfo();
                return (TextUtils.isEmpty(extraInfo) || extraInfo.length() < 3) ? false : extraInfo.contains(APNName.NAME_CTWAP);
            } catch (Exception e) {
                return false;
            }
        } catch (Exception e2) {
