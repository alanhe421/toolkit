...
public class q implements Serializable, Cloneable, org.apache.thrift.a<q, a> {
    ...
    private static final org.apache.thrift.protocol.b o = new org.apache.thrift.protocol.b("stringValue", JceStruct.STRUCT_END, (short) 6);
    ...
    static {
        ...
        enumMap.put(a.STRING_VALUE, new b("stringValue", (byte) 2, new c(JceStruct.STRUCT_END)));
    ...
    public boolean a(q qVar) {
        ...
        b = e();
        b2 = qVar.e();
        if ((b || b2) && (!b || !b2 || this.c != qVar.c)) {
            return false;
        }
        b = g();
        b2 = qVar.g();
        if ((b || b2) && (!b || !b2 || this.d != qVar.d)) {
            return false;
        }
        b = i();
        b2 = qVar.i();
        if ((b || b2) && (!b || !b2 || this.e != qVar.e)) {
            return false;
        }
        b = k();
        b2 = qVar.k();
        if ((b || b2) && (!b || !b2 || !this.f.equals(qVar.f))) {
            return false;
        }
        b = m();
        b2 = qVar.m();
        return !(b || b2) || (b && b2 && this.g == qVar.g);
    }
    ...
    public int b(q qVar) {
        ...
        compareTo = Boolean.valueOf(m()).compareTo(Boolean.valueOf(qVar.m()));
        if (compareTo != 0) {
            return compareTo;
        }
        if (m()) {
