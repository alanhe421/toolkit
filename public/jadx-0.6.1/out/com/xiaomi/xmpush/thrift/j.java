...
public class j implements Serializable, Cloneable, org.apache.thrift.a<j, a> {
    ...
    private static final org.apache.thrift.protocol.b g = new org.apache.thrift.protocol.b("location", JceStruct.ZERO_TAG, (short) 1);
    private static final org.apache.thrift.protocol.b h = new org.apache.thrift.protocol.b("provider", JceStruct.STRUCT_END, (short) 2);
    ...
    static {
        ...
        enumMap.put(a.LOCATION, new b("location", (byte) 1, new g(JceStruct.ZERO_TAG, m.class)));
        enumMap.put(a.PROVIDER, new b("provider", (byte) 2, new c(JceStruct.STRUCT_END)));
    ...
    public boolean a(j jVar) {
        ...
        boolean a = a();
        boolean a2 = jVar.a();
        if ((a || a2) && (!a || !a2 || !this.a.a(jVar.a))) {
            return false;
        }
        a = b();
        a2 = jVar.b();
        if ((a || a2) && (!a || !a2 || !this.b.equals(jVar.b))) {
            return false;
        }
        a = c();
        a2 = jVar.c();
        if ((a || a2) && (!a || !a2 || this.c != jVar.c)) {
            return false;
        }
        a = d();
        a2 = jVar.d();
        return !(a || a2) || (a && a2 && this.d == jVar.d);
    }
