...
public class aq implements Serializable, Cloneable, a<aq, a> {
    ...
    static {
        ...
        enumMap.put(a.e, new b(SocialConstants.TYPE_REQUEST, (byte) 2, new g(JceStruct.ZERO_TAG, ap.class)));
    ...
    public boolean a(aq aqVar) {
        ...
        a = e();
        a2 = aqVar.e();
        if ((a || a2) && (!a || !a2 || !this.e.a(aqVar.e))) {
            return false;
        }
        a = f();
        a2 = aqVar.f();
        if ((a || a2) && (!a || !a2 || this.f != aqVar.f)) {
            return false;
        }
        a = g();
        a2 = aqVar.g();
    ...
    public int b(aq aqVar) {
        ...
        compareTo = Boolean.valueOf(l()).compareTo(Boolean.valueOf(aqVar.l()));
        if (compareTo != 0) {
            return compareTo;
        }
        if (l()) {
