...
import com.xiaomi.channel.commonutils.c.d;
import com.xiaomi.push.b.b$f;
...
class c {
            ...
            while (!this.g) {
                ...
                switch (c.m()) {
                    ...
                    case (short) 2:
                        ...
                        try {
                            this.f.b(this.d.a(c.d(am.a().b(Integer.valueOf(c.c()).toString(), c.j()).i), this.f));
                            break;
                        } catch (Exception e) {
                            com.xiaomi.channel.commonutils.b.c.a("[Slim] Parse packet from Blob " + c.toString() + " failure:" + e.getMessage());
                            break;
                        }
                    case (short) 3:
                        try {
                            ...
                            com.xiaomi.channel.commonutils.b.c.a("[Slim] Parse packet from Blob " + c.toString() + " failure:" + e2.getMessage());
                            break;
                        }
                    default:
                        com.xiaomi.channel.commonutils.b.c.a("[Slim] unknow blob type " + c.m());
                        break;
                }
            }
            return;
    ...
    private ByteBuffer e() {
        ...
        com.xiaomi.channel.commonutils.b.c.a("CRC = " + ((int) this.c.getValue()) + " and " + c);
    ...
    b c() {
        ...
        try {
            ...
            try {
                e.flip();
                b b = b.b(e);
                com.xiaomi.channel.commonutils.b.c.c("[Slim] Read {cmd=" + b.a() + ";chid=" + b.c() + ";len=" + position + "}");
                return b;
                ...
                com.xiaomi.channel.commonutils.b.c.a(append.append(d.a(array, 0, i)).append("] Err:").append(iOException.getMessage()).toString());
                throw iOException;
            }
