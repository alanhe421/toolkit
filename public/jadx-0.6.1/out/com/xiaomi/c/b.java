...
public class b {
    ...
    public static b a(com.xiaomi.smack.packet.d dVar, String str) {
        ...
        try {
            ...
            c.a("Blob parse chid err " + e.getMessage());
        }
        bVar.a(i);
        bVar.a(dVar.k());
        bVar.c(dVar.n());
        ...
        try {
            ...
            c.a("Blob setPayload err： " + e2.getMessage());
        }
        return bVar;
    }
    ...
    static b b(ByteBuffer byteBuffer) {
        try {
            ...
            c.a("read Blob err :" + e.getMessage());
            throw new IOException("Malformed Input");
        }
    }
    ...
    public void c(String str) {
        if (!TextUtils.isEmpty(str)) {
            ...
            try {
                ...
                c.a("Blob parse user err " + e.getMessage());
            }
        }
    }
