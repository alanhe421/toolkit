...
/* compiled from: QRStrictLineReader */
        ...
        synchronized (this.a) {
            ...
            while (i2 != this.e) {
                if (this.c[i2] == (byte) 10) {
                    int i3 = (i2 == this.d || this.c[i2 - 1] != JceStruct.SIMPLE_LIST) ? i2 : i2 - 1;
            ...
            ByteArrayOutputStream anonymousClass1 = new ByteArrayOutputStream(this, (this.e - this.d) + 80) {
                ...
                public String toString() {
                    int i = (this.count <= 0 || this.buf[this.count - 1] != JceStruct.SIMPLE_LIST) ? this.count : this.count - 1;
                    try {
