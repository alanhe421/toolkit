...
public class HorizontalListView extends AdapterView<ListAdapter> {
    ...
    public HorizontalListView(Context context, AttributeSet attributeSet) {
        ...
        this.u = false;
        this.v = null;
        this.w = ScrollState.SCROLL_STATE_IDLE;
        this.A = false;
        this.B = false;
        this.D = new DataSetObserver(this) {
            final /* synthetic */ HorizontalListView a;
    ...
    private void a(Context context, AttributeSet attributeSet) {
        if (attributeSet != null) {
            ...
            Drawable drawable = obtainStyledAttributes.getDrawable(i.HorizontalListView_android_divider);
            if (drawable != null) {
                setDivider(drawable);
            }
            int dimensionPixelSize = obtainStyledAttributes.getDimensionPixelSize(i.HorizontalListView_dividerWidth, 0);
