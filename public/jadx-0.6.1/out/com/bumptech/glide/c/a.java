...
public class a {
    ...
    public void a(int i, int i2) {
        if (!this.g || this.r) {
            ...
            this.b = i2;
            if (this.a < 1) {
                this.a = ErrorCode.ERROR_SDKENGINE_ISCOMPATIBLE;
            }
            if (this.b < 1) {
                this.b = ETConverter.ET_CONVERTER_GLYPH_CACHE_SIZE_MASK;
            }
            this.s = true;
        }
    }
    ...
    private void f() throws IOException {
        c(this.a);
        c(this.b);
        this.h.write(this.o | ETConverter.ET_CONVERTER_GLYPH_CACHE_SIZE_MASK);
        this.h.write(0);
        this.h.write(0);
    }
