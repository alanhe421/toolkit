...
public class b extends com.bumptech.glide.load.resource.a.b implements com.bumptech.glide.load.resource.c.f.b {
    ...
    static class a extends ConstantState {
        ...
        public a(c cVar, byte[] bArr, Context context, f<Bitmap> fVar, int i, int i2, com.bumptech.glide.b.a.a aVar, com.bumptech.glide.load.engine.bitmap_recycle.c cVar2, Bitmap bitmap) {
            if (bitmap == null) {
    ...
    public b(Context context, com.bumptech.glide.b.a.a aVar, com.bumptech.glide.load.engine.bitmap_recycle.c cVar, f<Bitmap> fVar, int i, int i2, c cVar2, byte[] bArr, Bitmap bitmap) {
