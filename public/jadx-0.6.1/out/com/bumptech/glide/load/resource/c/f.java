...
class f {
    ...
    public Bitmap d() {
        return this.g != null ? this.g.a_() : null;
    }
    ...
    private void e() {
        if (this.d && !this.e) {
            this.e = true;
            this.b.a();
            this.f.b(new d()).b(new a(this.c, this.b.d(), SystemClock.uptimeMillis() + ((long) this.b.b())));
        }
    }
    ...
    private static e<com.bumptech.glide.b.a, com.bumptech.glide.b.a, Bitmap, Bitmap> a(Context context, com.bumptech.glide.b.a aVar, int i, int i2, com.bumptech.glide.load.engine.bitmap_recycle.c cVar) {
        com.bumptech.glide.load.d hVar = new h(cVar);
        l gVar = new g();
        return com.bumptech.glide.g.b(context).a(gVar, com.bumptech.glide.b.a.class).a((Object) aVar).a(Bitmap.class).b(com.bumptech.glide.load.resource.a.b()).b(hVar).b(true).b(DiskCacheStrategy.NONE).b(i, i2);
    }
}
