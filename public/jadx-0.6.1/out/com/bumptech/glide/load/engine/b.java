...
public class b implements com.bumptech.glide.load.engine.a.h.a, d, a {
    ...
    private static class b implements a {
        private final com.bumptech.glide.load.engine.a.a.a a;
        private volatile com.bumptech.glide.load.engine.a.a b;

        public b(com.bumptech.glide.load.engine.a.a.a aVar) {
            this.a = aVar;
        }
    ...
    public b(h hVar, com.bumptech.glide.load.engine.a.a.a aVar, ExecutorService executorService, ExecutorService executorService2) {
        this(hVar, aVar, executorService, executorService2, null, null, null, null, null);
    }

    b(h hVar, com.bumptech.glide.load.engine.a.a.a aVar, ExecutorService executorService, ExecutorService executorService2, Map<com.bumptech.glide.load.b, c> map, f fVar, Map<com.bumptech.glide.load.b, WeakReference<g<?>>> map2, a aVar2, j jVar) {
        this.c = hVar;
        this.g = new b(aVar);
        if (map2 == null) {
            map2 = new HashMap();
    ...
    public <T, Z, R> c a(com.bumptech.glide.load.b bVar, int i, int i2, com.bumptech.glide.load.a.c<T> cVar, com.bumptech.glide.e.b<T, Z> bVar2, com.bumptech.glide.load.f<Z> fVar, com.bumptech.glide.load.resource.e.c<Z, R> cVar2, Priority priority, boolean z, DiskCacheStrategy diskCacheStrategy, f fVar2) {
