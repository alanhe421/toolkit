...
public final class Version {
    ...
    private static Version[] buildVersions() {
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(3, a.cd), new ECB(1, 116));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(28, new ECB(4, 116), new ECB(4, Opcodes.INVOKE_SUPER_RANGE));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(6, Opcodes.INVOKE_SUPER_RANGE), new ECB(4, 118));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(28, new ECB(10, 114), new ECB(2, a.cd));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(3, Opcodes.INVOKE_SUPER_RANGE), new ECB(10, 118));
        ...
        iArr = new int[]{6, 30, 54, 78, 102, Opcodes.NOT_LONG};
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(7, 116), new ECB(7, Opcodes.INVOKE_SUPER_RANGE));
        ...
        iArr = new int[]{6, 26, 52, 78, 104, Opcodes.INT_TO_FLOAT};
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(5, a.cd), new ECB(10, 116));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(13, a.cd), new ECB(3, 116));
        ...
        iArr = new int[]{6, 34, 60, 86, 112, Opcodes.DOUBLE_TO_INT};
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(17, a.cd));
        ...
        iArr = new int[]{6, 30, 58, 86, 114, Opcodes.INT_TO_CHAR};
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(17, a.cd), new ECB(1, 116));
        ...
        iArr = new int[]{6, 34, 62, 90, 118, Opcodes.MUL_INT};
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(13, a.cd), new ECB(6, 116));
        ...
        iArr = new int[]{6, 30, 54, 78, 102, Opcodes.NOT_LONG, Opcodes.OR_INT};
        eCBlocksArr = new ECBlocks[4];
        ...
        iArr = new int[]{6, 24, 50, 76, 102, 128, Opcodes.USHR_INT};
        eCBlocksArr = new ECBlocks[4];
        ...
        iArr = new int[]{6, 28, 54, 80, 106, Opcodes.LONG_TO_INT, Opcodes.DIV_LONG};
        eCBlocksArr = new ECBlocks[4];
        ...
        iArr = new int[]{6, 32, 58, 84, 110, Opcodes.FLOAT_TO_LONG, Opcodes.XOR_LONG};
        eCBlocksArr = new ECBlocks[4];
        ...
        iArr = new int[]{6, 26, 54, 82, 110, Opcodes.DOUBLE_TO_INT, Opcodes.ADD_FLOAT};
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(20, Opcodes.INVOKE_SUPER_RANGE), new ECB(4, 118));
        ...
        iArr = new int[]{6, 30, 58, 86, 114, Opcodes.INT_TO_CHAR, Opcodes.REM_FLOAT};
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(19, 118), new ECB(6, Opcodes.INVOKE_STATIC_RANGE));
