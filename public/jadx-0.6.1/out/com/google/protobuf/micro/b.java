...
public final class b {
    ...
    public int j() {
        ...
        int i = o & Opcodes.NEG_FLOAT;
        byte o2 = o();
        if (o2 >= (byte) 0) {
            return i | (o2 << 7);
        }
        i |= (o2 & Opcodes.NEG_FLOAT) << 7;
        o2 = o();
        if (o2 >= (byte) 0) {
            return i | (o2 << 14);
        }
        i |= (o2 & Opcodes.NEG_FLOAT) << 14;
        o2 = o();
        if (o2 >= (byte) 0) {
            return i | (o2 << 21);
        }
        i |= (o2 & Opcodes.NEG_FLOAT) << 21;
        o2 = o();
        i |= o2 << 28;
        if (o2 >= (byte) 0) {
            return i;
