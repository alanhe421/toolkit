...
public abstract class DLBasePluginFragmentActivity extends FragmentActivity implements IDLPluginActivity {
    private View a = null;
    private Theme b;
    ...
    public void peformOnWindowAttributesChanged(LayoutParams layoutParams) {
    ...
    public void attach(IDLProxyActivity iDLProxyActivity, DLPluginPackage dLPluginPackage, Theme theme) {
        ...
        if (this.a != null) {
            iDLProxyActivity.setContentView(this.a);
        }
    }
