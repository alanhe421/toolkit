...
public final class c extends b implements i {
    ...
    private void a(int i, int i2) throws IOException {
        ...
        try {
            ...
            this.n = okio.j.a(okio.j.b(this.i));
            this.o = okio.j.a(okio.j.a(this.i));
        } catch (Throwable e) {
        ...
        try {
            ...
            try {
                ...
                if (a.j().verify(a.a().f(), socket2.getSession())) {
                    ...
                    this.j = socket2;
                    this.n = okio.j.a(okio.j.b(this.j));
                    this.o = okio.j.a(okio.j.a(this.j));
                    this.k = a3;
    ...
    private w f() {
        return new w.a().a(this.h.a().a()).a("Host", okhttp3.internal.c.a(this.h.a().a(), true)).a("Proxy-Connection", "Keep-Alive").a("User-Agent", okhttp3.internal.d.a()).b();
    }
    ...
    public okhttp3.internal.b.c a(u uVar, f fVar) throws SocketException {
        if (this.m != null) {
            return new okhttp3.internal.http2.d(uVar, fVar, this.m);
        }
        this.j.setSoTimeout(uVar.b());
        this.n.a().a((long) uVar.b(), TimeUnit.MILLISECONDS);
        this.o.a().a((long) uVar.c(), TimeUnit.MILLISECONDS);
        return new okhttp3.internal.c.a(uVar, fVar, this.n, this.o);
    }
