...
public final class e {
    ...
    public aa b() throws IOException {
        ...
        this.d = f();
        aa aaVar = new aa(this.a, this.c, this.d);
        if (!this.b.c(aaVar)) {
            return aaVar;
        }
        this.i.add(aaVar);
    ...
    public void a(aa aaVar, IOException iOException) {
        if (!(aaVar.b().type() == Type.DIRECT || this.a.g() == null)) {
            this.a.g().connectFailed(this.a.a().a(), aaVar.b().address(), iOException);
        }
        this.b.a(aaVar);
    }
