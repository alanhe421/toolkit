...
public final class HttpUrl {
    ...
    public static final class Builder {
        ...
        ParseResult a(HttpUrl httpUrl, String str) {
            int d;
            int a = okhttp3.internal.c.a(str, 0, str.length());
            int b = okhttp3.internal.c.b(str, a, str.length());
            if (b(str, a, b) != -1) {
            ...
            if (c >= 2 || httpUrl == null || !httpUrl.a.equals(this.a)) {
                ...
                while (true) {
                    Object obj3;
                    Object obj4;
                    int a2 = okhttp3.internal.c.a(str, i, b, "@/\\?#");
                    switch (a2 != b ? str.charAt(a2) : '￿') {
                        ...
                        case '@':
                            if (obj == null) {
                                a = okhttp3.internal.c.a(str, i, a2, ':');
            ...
            d = okhttp3.internal.c.a(str, a, b, "?#");
            a(str, a, d);
            if (d >= b || str.charAt(d) != '?') {
                a = d;
            } else {
                a = okhttp3.internal.c.a(str, d, b, '#');
        ...
        private void a(String str, int i, int i2) {
            if (i != i2) {
                ...
                int i3 = i;
                while (i3 < i2) {
                    int a = okhttp3.internal.c.a(str, i3, i2, "/\\");
                    boolean z = a < i2;
                    a(str, i3, a, z, true);
                    if (z) {
                        a++;
    ...
    public List<String> i() {
        ...
        while (indexOf < a) {
            int i = indexOf + 1;
            indexOf = okhttp3.internal.c.a(this.j, i, a, '/');
    ...
    static String a(String str, int i, int i2, String str2, boolean z, boolean z2, boolean z3, boolean z4) {
        ...
        while (i3 < i2) {
            int codePointAt = str.codePointAt(i3);
            if (codePointAt < 32 || codePointAt == Opcodes.NEG_FLOAT || ((codePointAt >= 128 && z4) || str2.indexOf(codePointAt) != -1 || ((codePointAt == 37 && (!z || (z2 && !a(str, i3, i2)))) || (codePointAt == 43 && z3)))) {
                okio.c cVar = new okio.c();
                cVar.a(str, i, i3);
        ...
        while (i < i2) {
            ...
            if (!(z && (codePointAt == 9 || codePointAt == 10 || codePointAt == 12 || codePointAt == 13))) {
                if (codePointAt == 43 && z3) {
                    cVar.a(z ? "+" : "%2B");
                } else if (codePointAt < 32 || codePointAt == Opcodes.NEG_FLOAT || ((codePointAt >= 128 && z4) || str2.indexOf(codePointAt) != -1 || (codePointAt == 37 && (!z || (z2 && !a(str, i, i2)))))) {
                    if (cVar2 == null) {
                        cVar2 = new okio.c();
                    }
                    cVar2.a(codePointAt);
