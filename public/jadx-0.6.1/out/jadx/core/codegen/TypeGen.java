...
public class TypeGen {
    ...
    private static String literalToString(long lit, ArgType type, StringUtils stringUtils) {
        if (type == null || !type.isTypeKnown()) {
            ...
            if (Math.abs(lit) > 100) {
                n = n + "; // 0x" + Long.toHexString(lit) + " float:" + Float.intBitsToFloat((int) lit) + " double:" + Double.longBitsToDouble(lit);
            }
            return n;
        }
        switch (type.getPrimitiveType()) {
            ...
            case CHAR:
                return stringUtils.unescapeChar((char) ((int) lit));
            case BYTE:
                return formatByte((byte) ((int) lit));
            case SHORT:
                return formatShort((short) ((int) lit));
            case INT:
            ...
            case ARRAY:
                ...
                LOG.warn("Wrong object literal: {} for type: {}", Long.valueOf(lit), type);
