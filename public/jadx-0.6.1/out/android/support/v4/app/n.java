...
class n {
    ...
    public static void a(Object obj, Object obj2, View view, b bVar, View view2, a aVar, Map<String, String> map, ArrayList<View> arrayList, Map<String, View> map2, Map<String, View> map3, ArrayList<View> arrayList2) {
        if (obj != null || obj2 != null) {
            ...
            if (obj2 != null) {
                a(obj2, view2, (Map) map2, (ArrayList) arrayList2);
            }
            if (bVar != null) {
        ...
        if (transition4 != null) {
            ...
            view.getViewTreeObserver().addOnPreDrawListener(new OnPreDrawListener() {
                public boolean onPreDraw() {
                    view3.getViewTreeObserver().removeOnPreDrawListener(this);
                    if (transition != null) {
                        n.a(transition, arrayList5);
                    }
                    if (transition2 != null) {
                        n.a(transition2, arrayList6);
                    }
                    if (transition3 != null) {
                        n.a(transition3, arrayList7);
                    }
