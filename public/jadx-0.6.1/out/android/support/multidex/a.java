...
public final class a {
    ...
    L_0x001e:
        ...
        throw r0;
    L_0x004c:
        r0 = b(r6);	 Catch:{ Exception -> 0x0064 }
        if (r0 == 0) goto L_0x0019;
    L_0x0052:
        r1 = b;	 Catch:{ Exception -> 0x0064 }
    ...
    L_0x00fe:
        ...
        goto L_0x0019;
    L_0x010b:
        c(r6);	 Catch:{ Throwable -> 0x0131 }
    L_0x010e:
        r3 = new java.io.File;	 Catch:{ all -> 0x0061 }
        r4 = r0.dataDir;	 Catch:{ all -> 0x0061 }
        r5 = a;	 Catch:{ all -> 0x0061 }
        r3.<init>(r4, r5);	 Catch:{ all -> 0x0061 }
        r4 = 0;
        r4 = android.support.multidex.b.a(r6, r0, r3, r4);	 Catch:{ all -> 0x0061 }
        r5 = a(r4);	 Catch:{ all -> 0x0061 }
        if (r5 == 0) goto L_0x013c;
    L_0x0122:
        a(r2, r3, r4);	 Catch:{ all -> 0x0061 }
    L_0x0125:
        monitor-exit(r1);	 Catch:{ all -> 0x0061 }
        r0 = "MultiDex";
        r1 = "install done";
    ...
    L_0x013c:
        ...
        r4 = 1;
        r0 = android.support.multidex.b.a(r6, r0, r3, r4);	 Catch:{ all -> 0x0061 }
        r4 = a(r0);	 Catch:{ all -> 0x0061 }
        if (r4 == 0) goto L_0x0154;
    L_0x0150:
        a(r2, r3, r0);	 Catch:{ all -> 0x0061 }
        goto L_0x0125;
    L_0x0154:
